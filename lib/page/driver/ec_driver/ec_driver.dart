...
class EmergencyCallDriver extends StatefulWidget {
  const EmergencyCallDriver({Key key}) : super(key: key);

  @override
  _EmergencyCallDriverState createState() => _EmergencyCallDriverState();
}

class _EmergencyCallDriverState extends State<EmergencyCallDriver> {

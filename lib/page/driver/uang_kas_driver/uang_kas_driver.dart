...
class UangKasDriver extends StatefulWidget {
  const UangKasDriver({Key key}) : super(key: key);

  @override
  _UangKasDriverState createState() => _UangKasDriverState();
}

class _UangKasDriverState extends State<UangKasDriver> {
  InfinitListRepository repo = InfinitListRepository();
  List<Datum> uangKas = [];
  String urlUangKas = UANG_KAS_URL;
  String total = "0";

...
class PanicButtonPenumpang extends StatefulWidget {
  const PanicButtonPenumpang({Key key}) : super(key: key);

  @override
  _PanicButtonPenumpangState createState() => _PanicButtonPenumpangState();
}

class _PanicButtonPenumpangState extends State<PanicButtonPenumpang> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: appBarPenumpang('Panic Button', () {
        Get.back();
      }),
      body: Container(
        height: Get.height,
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              hbox(10),
              welcomeText('Detail Peristiwa', textStyle16Abu()),
              hbox(10),
              Container(
              ...
              hbox(10),
              welcomeText('Foto Peristiwa', textStyle16Abu()),
              hbox(10),
              _selectedImage != null
                      ...
                      children: [
                        ...
                        buttonLaporKejadian(
                          ...
                          if (_selectedImage != null && detail.text != '') {
                            ...
                            var data = await repo.postData('Panic Button',
                                PANIC_URL, detail.text, _selectedImage.path);

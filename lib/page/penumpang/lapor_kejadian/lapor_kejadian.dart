...
class LaporKejadianPenumpang extends StatefulWidget {
  const LaporKejadianPenumpang({Key key}) : super(key: key);

  @override
  _LaporKejadianPenumpangState createState() => _LaporKejadianPenumpangState();
}

class _LaporKejadianPenumpangState extends State<LaporKejadianPenumpang> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: appBarPenumpang('Lapor Kejadian', () {
        Get.back();
      }),
      body: Container(
        height: Get.height,

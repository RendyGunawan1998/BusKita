...
//
//     final perjalananAvailModel = perjalananAvailModelFromJson(jsonString);

import 'dart:convert';

List<PerjalananAvailModel> perjalananAvailModelFromJson(String str) =>
    List<PerjalananAvailModel>.from(
        json.decode(str).map((x) => PerjalananAvailModel.fromJson(x)));

String perjalananAvailModelToJson(List<PerjalananAvailModel> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class PerjalananAvailModel {
  PerjalananAvailModel({
    this.id,
    this.kendaraan,
    this.rute,
    this.hargaTiket,
  ...
  factory PerjalananAvailModel.fromJson(Map<String, dynamic> json) =>
      PerjalananAvailModel(
